...
describe('error-capture-post-tool', () => {
  before(() => {
    ...
    delete require.cache[require.resolve('../../.claude/hooks/safety/error-capture-post-tool.cjs')];
    errorCapture = require('../../.claude/hooks/safety/error-capture-post-tool.cjs');
  });
