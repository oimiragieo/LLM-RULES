...
describe('SPEC-018 Category 1: Workflow Composition', () => {
  ...
  test('01.01: should compose two workflows sequentially', async () => {
    ...
    const workflow2 = {
      name: 'workflow2',
      phases: [{ name: 'phase3', tasks: ['task3'] }],
    };
  ...
  test('01.04: should include multiple sub-workflows', async () => {
    const mainWorkflow = {
      name: 'main',
      phases: [{ include: 'sub1' }, { include: 'sub2' }, { include: 'sub3' }],
    };
  ...
  test('01.11: should compose workflows with parameters', async () => {
    const template = {
      name: 'template',
      phases: [{ name: 'process', tasks: ['{{taskName}}'] }],
    };
  ...
  test('01.15: should handle missing sub-workflow gracefully', async () => {
    const mainWorkflow = {
      name: 'main',
      phases: [{ include: 'non-existent-workflow' }],
    };
    ...
    await assert.rejects(async () => composer.flatten(mainWorkflow), {
...
describe('SPEC-018 Category 2: Workflow Inheritance', () => {
  ...
  test('02.03: should override phase properties in child', async () => {
    const parent = {
      name: 'parent',
      phases: [{ name: 'phase1', tasks: ['task1'], timeout: 5000 }],
    };
    const child = {
      name: 'child',
      extends: 'parent',
  ...
  test('02.05: should remove tasks from inherited phase', async () => {
    const parent = {
      name: 'parent',
      phases: [{ name: 'phase1', tasks: ['task1', 'task2', 'task3'] }],
    };
    const child = {
      name: 'child',
      extends: 'parent',
  ...
  test('02.06: should insert new phase before existing phase', async () => {
    ...
    const child = {
      name: 'child',
      extends: 'parent',
      phases: [{ name: 'phase1.5', tasks: ['task1.5'], insertBefore: 'phase2' }],
    };
  ...
  test('02.07: should insert new phase after existing phase', async () => {
    ...
    const child = {
      name: 'child',
      extends: 'parent',
      phases: [{ name: 'phase1.5', tasks: ['task1.5'], insertAfter: 'phase1' }],
    };
  ...
  test('02.11: should prevent execution of abstract parent workflows', async () => {
    ...
    await assert.rejects(async () => validator.validateForExecution(parent), {
...
describe('SPEC-018 Category 3: Cycle Detection', () => {
  ...
  test('03.02: should detect two-node cycle', async () => {
    ...
    await assert.rejects(async () => detector.detectCycles(workflow1, registry), {
      message: /circular.*dependency/i,
    });
  });
  ...
  test('03.04: should not detect cycle in long chain', async () => {
    ...
    await assert.doesNotReject(async () => detector.detectCycles(workflows[0], registry));
  });
  ...
  test('03.05: should handle multiple includes without cycle', async () => {
    ...
    await assert.doesNotReject(async () => detector.detectCycles(workflow1, registry));
  });
  ...
  test('03.06: should handle diamond dependency without cycle', async () => {
    ...
    await assert.doesNotReject(async () => detector.detectCycles(top, registry));
  });
  ...
  test('03.10: should not detect cycle in workflow without dependencies', async () => {
    ...
    await assert.doesNotReject(async () =>
      detector.detectCycles(workflow, new Map([[workflow.name, workflow]]))
    );
  });
...
describe('SPEC-018 Category 4: Hierarchy Flattening', () => {
  ...
  test('04.03: should resolve all includes during flattening', async () => {
    const main = {
      name: 'main',
      phases: [{ include: 'sub1' }, { include: 'sub2' }],
    };
    const sub1 = {
      name: 'sub1',
  ...
  test('04.05: should validate phase dependencies after flattening', async () => {
    ...
    const flattened = await composer.flatten(workflow);
    const validator = new WorkflowValidator();
    await assert.doesNotReject(async () => validator.validateDependencies(flattened));
  });
  ...
  test('04.11: should resolve all variables during flattening', async () => {
    const workflow = {
      ...
      phases: [{ name: 'deploy', tasks: ['deploy-{{env}}-{{region}}'] }],
    };
...
describe('SPEC-018 Category 5: Validation & Error Handling', () => {
  ...
  test('05.01: should validate workflow structure', async () => {
    ...
    await assert.rejects(async () => validator.validate(invalid), { message: /missing.*name/i });
  });
  ...
  test('05.02: should validate phase structure', async () => {
    ...
    await assert.rejects(async () => validator.validate(workflow), {
  ...
  test('05.03: should validate task references exist', async () => {
    const workflow = {
      name: 'invalid-ref',
      phases: [{ name: 'phase1', tasks: ['{{undefinedVar}}'] }],
    };
  ...
  test('05.04: should validate dependencies are satisfied', async () => {
    const workflow = {
      name: 'invalid-dep',
      phases: [{ name: 'phase1', tasks: ['task1'], dependsOn: ['non-existent-phase'] }],
    };

    await assert.rejects(async () => validator.validateDependencies(workflow), {
  ...
  test('05.06: should validate maximum nesting depth', async () => {
          ...
          subphases: [
            {
              ...
              subphases: [
                {
                  name: 'p1.1.1',
                  subphases: [{ name: 'p1.1.1.1', tasks: ['task'] }],
                },
              ],
            },
          ],
    ...
    await assert.rejects(async () => validator.validate(workflow, { maxNestingDepth: 3 }), {
  ...
  test('05.09: should provide helpful error messages', async () => {
    const workflow = {
      name: 'bad-workflow',
      phases: [{ name: 'phase1', tasks: ['{{undefined}}'] }],
    };
  ...
  test('05.10: should validate after composition', async () => {
    ...
    await assert.rejects(async () => validator.validate(composed), {
      message: /at least one task/i,
    });
  });
});
