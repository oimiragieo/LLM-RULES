...
const specContent = WebFetch({
  ...
  prompt: "Extract all API endpoints with their HTTP methods, paths, parameters, and descriptions. Return as structured JSON."
});
```
...
```json
{
  ...
  "parameters": {
    ...
    "language": { "type": "string", "required": false, "in": "query", "description": "ISO 639-1 language code" }
  },
