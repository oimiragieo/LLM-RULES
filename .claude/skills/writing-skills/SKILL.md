...
best_practices:
  - RED: Baseline test without skill first
  - GREEN: Write minimal skill addressing violations
...
source: builtin
trust_score: 100
provenance_sha: d03c39de69a26581
---
...
- V Good: `**REQUIRED SUB-SKILL:** Use tdd`
- V Good: `**REQUIRED BACKGROUND:** You MUST understand debugging`
- X Bad: `See skills/testing/test-driven-development` (unclear if required)
- X Bad: `@skills/testing/test-driven-development/SKILL.md` (force-loads, burns context)
