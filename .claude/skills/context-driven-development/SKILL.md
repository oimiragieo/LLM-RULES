...
source: builtin
trust_score: 100
provenance_sha: 2ca856bc090f3a52
---
...
- Onboarding team members to an existing project
...
1. Create all artifacts interactively
...
1. Analyze existing code, configs, and documentation
2. Pre-populate artifacts based on discovered patterns
3. Review and refine generated context
4. Reconcile existing patterns with desired patterns
...
- Pin product.md for quick reference
...
Support multi-session development through context persistence:

### Starting a New Session

1. Read product.md to orient yourself
