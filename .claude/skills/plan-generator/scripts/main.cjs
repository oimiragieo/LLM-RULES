...
'use strict';
/**
 * plan-generator - Enterprise Skill Script
...
if (options.help) {
  console.log(`
plan-generator - Enterprise Skill
...
if (options.list) {
  console.log('Guidelines for plan-generator:');
  console.log('See SKILL.md for full guidelines');
  process.exit(0);
}

console.log('plan-generator skill loaded. Use with Claude for code review.');
