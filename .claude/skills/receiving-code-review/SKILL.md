...
source: builtin
trust_score: 100
provenance_sha: 4dc598146d71ebf4
---
...
1. **NEVER** implement feedback before verifying it is technically correct for this specific codebase — reviewer suggestions are proposals, not orders.
2. **ALWAYS** clarify every unclear item before implementing any — partial understanding of a multi-item review produces wrong implementations that compound each other.
3. **NEVER** write performative agreement ("great point!", "you're absolutely right!") — technical acknowledgment or corrected code is the only valid response.
4. **ALWAYS** implement fixes one item at a time with individual test verification — batch implementations without testing create cascading bugs.
5. **NEVER** implement a suggested feature that grep confirms is unused — YAGNI applies; unused code is technical debt disguised as improvement.
