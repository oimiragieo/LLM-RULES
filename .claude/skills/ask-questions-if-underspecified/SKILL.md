...
verified: true
lastVerifiedAt: 2026-02-21T19:25:54.996Z
best_practices:
...
<capabilities>
- Ask Questions If Underspecified primary function
...
```bash
# Invoke this skill
/ask-questions-if-underspecified [arguments]

# Or run the script directly
node .claude/skills/ask-questions-if-underspecified/scripts/main.cjs --help
```
