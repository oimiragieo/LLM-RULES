...
function main() {
  ...
  const skillPath = path.resolve(
    __dirname,
    '../../skills/paraglide-js-internationalization-i18n/SKILL.md'
  );
  ...
  const result = {
    ...
    skillPath: skillPath,
    message:
      'Skill paraglide-js-internationalization-i18n is available. Invoke via Skill({ skill: "paraglide-js-internationalization-i18n" }) in agent context.',
  };
