...
const hookPath = path.join(PROJECT_ROOT, '.claude', 'hooks', 'validation', 'pre-completion-validation.cjs');
...
const r = spawnSync(process.execPath, [hookPath], { input, cwd: PROJECT_ROOT, encoding: 'utf8', timeout: 10000 });
