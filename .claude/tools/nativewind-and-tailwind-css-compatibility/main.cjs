...
function main() {
  ...
  const skillPath = path.resolve(
    __dirname,
    '../../skills/nativewind-and-tailwind-css-compatibility/SKILL.md'
  );
  ...
  const result = {
    ...
    skillPath: skillPath,
    message:
      'Skill nativewind-and-tailwind-css-compatibility is available. Invoke via Skill({ skill: "nativewind-and-tailwind-css-compatibility" }) in agent context.',
  };
