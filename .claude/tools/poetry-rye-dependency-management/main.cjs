...
function main() {
  ...
  const skillPath = path.resolve(__dirname, '../../skills/poetry-rye-dependency-management/SKILL.md');
  ...
  const result = {
    ...
    status: 'ready',
    skillPath: skillPath,
    message: 'Skill poetry-rye-dependency-management is available. Invoke via Skill({ skill: "poetry-rye-dependency-management" }) in agent context.'
  };
