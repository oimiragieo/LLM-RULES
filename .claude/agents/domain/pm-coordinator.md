...
- New planning pattern/template → Append to `.claude/context/memory/learnings.md`
- Process or tooling decision → Append to `.claude/context/memory/decisions.md`
- Recurring delivery blocker → Append to `.claude/context/memory/issues.md`
