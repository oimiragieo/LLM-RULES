...
- New UX pattern/insight → Append to `.claude/context/memory/learnings.md`
- Recurring usability issue → Append to `.claude/context/memory/issues.md`
- Research method decision → Append to `.claude/context/memory/decisions.md`

**During long research tasks:** Use `.claude/context/memory/active_context.md` as scratchpad.
