...
version: 1.0.0
description: >-
  Native Android development expert for Kotlin, Jetpack Compose, and Android SDK. Use for building native Android
  applications, Material Design interfaces, and Android platform integrations.
model: sonnet
temperature: 0.4
