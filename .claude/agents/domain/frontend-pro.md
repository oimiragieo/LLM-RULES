...
version: 1.0.0
description: >-
  Frontend development expert for React, Vue, modern CSS, component libraries, and UI/UX implementation. Use for
  building user interfaces, component libraries, responsive designs, accessibility, and frontend architecture.
model: sonnet
temperature: 0.4
