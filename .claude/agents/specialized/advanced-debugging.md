...
Review past debugging sessions, known root causes, and recurring patterns.

**After completing work, record findings:**

- New debugging pattern or root cause → Append to `.claude/context/memory/learnings.md`
- Root cause analysis decision → Append to `.claude/context/memory/decisions.md`
