...
| ---------------------------------- | ------------------- | ------------- | --------------------------------------- |
| mcp**chrome-devtools**\*           | chrome-devtools     | NO            | Skill({ skill: 'chrome-browser' })      |
| mcp**sequential-thinking**\*       | sequential-thinking | .mcp.json YES | Skill({ skill: 'sequential-thinking' }) |
| mcp**Ref**ref_search_documentation | Ref                 | NO            | WebSearch + WebFetch                    |
| mcp**Ref**ref_read_url             | Ref                 | NO            | WebFetch                                |
| mcp**Exa**web_search_exa           | Exa                 | NO            | WebSearch                               |
| mcp**Exa**get_code_context_exa     | Exa                 | NO            | Grep + Glob                             |
| mcp**Exa**company_research_exa     | Exa                 | NO            | WebSearch                               |
| mcp**shadcn**getComponents         | shadcn              | NO            | WebFetch                                |
| mcp**shadcn**getComponent          | shadcn              | NO            | WebFetch                                |
