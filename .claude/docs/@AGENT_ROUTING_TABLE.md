...
Complete agent routing matrix mapping request types to agent definitions across 4 categories: core agents, specialized agents, domain agents, and orchestrators. Registry contains 110 agents.
...
| Autonomous loop governance, circuit breaker, iteration safety | `loop-operator`              | `.claude/agents/orchestrators/loop-operator.md`          |
...
| Memory audit, memory cleanup, memory health, memory rotation  | `memory-manager`             | `.claude/agents/specialized/memory-manager.md`           |
