...
Complete agent routing matrix mapping request types to agent definitions across 4 categories: core agents, specialized agents, domain agents, and orchestrators. Registry contains 119 agents.
